...
const char* ObjectStatusMaskType::s_bitNameList[] = 
{
	...
	"DISGUISED",
	"DEPLOYED",
	"CAN_COMBATDROP", // new statuses start from here @hanfield
	"IMMOBILIZED",
	"CANNOT_HEAL",
	"CANNOT_BE_GARRISONED",
	"CANNOT_BE_CLEARED_BY_GARRISON_CLEARING",
	"DOES_NOT_TRIGGER_MINES",
	"IMMUNE_TO_MINE_DAMAGE",
	"DOES_NOT_TRIGGER_BOOBYTRAPS",
	"TURN_DAMAGE_TO_HEALTH",
	"GRANTS_BOUNTY",
	"CONSUMES_NO_POWER",
